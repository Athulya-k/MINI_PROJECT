...
<body>
<ul>
<li><a href="../staff/s_home.php">HOME</a></li>
<li style="float:right;"><a href="../staff/a_logout.php">LOGOUT</a></li>
</ul>
...
values(id,'".$uid."','".$uname."','".$dob."','".$age."','".$gender."','".$dept."','".$adno."','".$photo."','".$password."',CURRENT_TIMESTAMP())";
...
echo"<script>alert('Registration is done Successfully.Your UserID is : $uid and Your Password is : $password');
window.location.replace('../staff/s_home.php');</script>";
